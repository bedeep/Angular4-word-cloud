...
var AgWordCloudDirective = (function () {
    ...
    function AgWordCloudDirective(element) {
        ...
        this.wordClick = new core.EventEmitter();
     ...
     * @return {?}
     */
    AgWordCloudDirective.prototype.getTextRotation = function () {
        var /** @type {?} */ defaultRotation = function () { return ~~(Math.random() * 1) * 90; };
        try {
